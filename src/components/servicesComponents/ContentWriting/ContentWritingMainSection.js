...
import { GraphicsDesignSlider } from "../GraphicsDesign/GraphicsDesignSlider";
import { ContentWritingSlide } from "./ContentWritingSlider";

const GraphicDesignMainSection = () => {
  return (
...
export default GraphicDesignMainSection;
