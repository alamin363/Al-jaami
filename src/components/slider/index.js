                ...
                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                  <div className="slide__content">
                    ...
                    <p className="slide__desc">
                      Our sites are designed to each group's specific needs. We
                      can help your company with anything from landing pages,
                      style, photos, graphics, and media to branding, marketing,
                      analytics, and sales strategy. We can make it happen.
                    </p>
                    <Link
                      href="/about_us"
                ...
                <div className="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                  <div className="slide__content">
                    <h2 className="slide__title">
                      We love dealing with companies who have innovative ideas.
                    </h2>
                    <p className="slide__desc">
                    ...
                    <Link href="/" className="btn btn__primary btn__icon mr-30">
                      <span>More About Us</span>
