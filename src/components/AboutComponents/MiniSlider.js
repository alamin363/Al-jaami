    ...
    <Slider {...settings}>
      <div style={{ height: "400px" }} className="mini-fancybox fancybox-item">
        <div className="fancybox__icon-img">
          <Image width={64} height={64} src={slide1} alt="icon" />
        </div>
      ...
      <div className="fancybox-item">
        ...
        <div className="fancybox__icon-img">
          <Image width={64} height={70} src={slide2} alt="icon" />
        </div>
        <div className="fancybox__content">
      ...
      <div className="fancybox-item">
        <div className="fancybox__icon-img">
          <Image width={100} height={31} src={slide3} alt="icon" />
        </div>
        <div className="fancybox__content">
      ...
      <div className="fancybox-item">
        <div className="fancybox__icon-img">
          <Image width={100} height={31} src={slide4} alt="icon" />
        </div>
        <div className="fancybox__content">
